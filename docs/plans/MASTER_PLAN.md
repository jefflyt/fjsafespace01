...
- **Constraints & Assumptions**:
  ...
  - Locked decision: Supabase Storage for file storage and native Postgres for database.
...
- **File Storage**: Supabase Storage (for raw scan uploads, generated PDF reports).
...
- **Scope**: FastAPI endpoint for CSV ingest, Supabase Storage helper. Upload queue table in frontend.
